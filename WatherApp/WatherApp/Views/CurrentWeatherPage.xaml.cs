...
using WatherApp.Helper;
using WatherApp.Models;
using Xamarin.Forms;
using Xamarin.Forms.Xaml;

namespace WatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        {
            //var url = $"api.openweathermap.org/data/2.5/weather?lat=35&lon=139&appid=cf8153eb9c27175c43021ba5d379e3c4";
            ...
            {
                await DisplayAlert("Weather info", "Please tray later", "OK!");
            }
        }
        private async void GetForecast()
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q=Tehran&appid=cf8153eb9c27175c43021ba5d379e3c4";
            var result = await ApiCaller.Get(url);
